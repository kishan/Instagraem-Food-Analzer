Template.test_template.helpers({
  'feature' : function () {
    return [
      { 'text' : 'sadasdasdadasd', 'icon' : 'archive', 'path' : '#packages' },
      { 'text' : 'sadasdasdadasd', 'icon' : 'terminal', 'path' : '#console-tool' },
      { 'text' : 'sadasdasdadasd', 'icon' : 'html5', 'color' : 'hover-orange', 'path' : '#html5' },
      { 'text' : 'sadasdasdadasd', 'icon' : 'folder', 'path' : '#structure' }
    ];
  },
  'package' : function () {
    return [
...
Template.test_template.events({
});


Template.test_template.rendered = function () {
